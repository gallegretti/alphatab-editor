...
describe('Gp5ImporterTest', () => {
    it('score-info', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/score-info.gp5');
    ...
    it('notes', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/notes.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkNotes(score);
    }));
    it('time-signatures', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/time-signatures.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkTimeSignatures(score);
    }));
    it('dead', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/dead.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkDead(score);
    }));
    it('grace', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/grace.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkGrace(score);
    }));
    it('accentuations', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/accentuations.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkAccentuations(score, true);
    }));
    it('harmonics', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/harmonics.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkHarmonics(score);
    }));
    it('hammer', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/hammer.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkHammer(score);
    }));
    it('bend', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/bends.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkBend(score);
    }));
    it('tremolo', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/tremolo.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkTremolo(score);
    }));
    it('slides', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/slides.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkSlides(score);
    }));
    it('vibrato', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/vibrato.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkVibrato(score, true);
    }));
    it('trills', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/trills.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkTrills(score);
    }));
    it('other-effects', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/other-effects.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkOtherEffects(score, false);
    }));
    it('fingering', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/fingering.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkFingering(score);
    }));
    it('stroke', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/strokes.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkStroke(score);
    }));
    it('tuplets', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/tuplets.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkTuplets(score);
    }));
    it('ranges', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/ranges.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkRanges(score);
    }));
    it('effects', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/effects.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkEffects(score);
    }));
    it('serenade', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/serenade.gp5');
        reader.readScore();
        // only Check reading
    }));
    it('strings', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/strings.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkStrings(score);
    }));
    it('key-signatures', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/key-signatures.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkKeySignatures(score);
    }));
    it('chords', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/chords.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkChords(score);
    }));
    it('colors', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/colors.gp5');
        let score = reader.readScore();
        GpImporterTestHelper.checkColors(score);
    }));
    it('canon', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/canon.gp5');
        let score = reader.readScore();
    ...
    it('beat-text-lyrics', () => __awaiter(void 0, void 0, void 0, function* () {
        const settings = new Settings();
        settings.importer.beatTextAsLyrics = true;
        const reader = yield GpImporterTestHelper.prepareImporterWithFile('guitarpro5/beat-text-lyrics.gp5', settings);
        let score = reader.readScore();
...
//# sourceMappingURL=Gp5Importer.test.js.map