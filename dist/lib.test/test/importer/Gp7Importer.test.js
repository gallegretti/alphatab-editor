...
describe('Gp7ImporterTest', () => {
    const prepareGp7ImporterWithFile = (name) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it('score-info', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/score-info.gp');
    ...
    it('bends-advanced', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/bends-advanced.gp');
        let score = reader.readScore();
    ...
    it('whammy-advanced', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/whammy-advanced.gp');
        let score = reader.readScore();
        // Bar 1
    ...
    it('tremolo', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/tremolo.gp');
        let score = reader.readScore();
    ...
    it('ottavia', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/ottavia.gp');
        let score = reader.readScore();
    ...
    it('simile-mark', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/simile-mark.gp');
        let score = reader.readScore();
    ...
    it('anacrusis', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/anacrusis.gp');
        let score = reader.readScore();
    ...
    it('left-hand-tap', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/left-hand-tap.gp');
        let score = reader.readScore();
    ...
    it('fermata', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/fermata.gp');
        let score = reader.readScore();
        ...
        let types = [FermataType.Short, FermataType.Medium, FermataType.Long];
        for (let i = 0; i < 3; i++) {
            ...
            let beats = score.tracks[0].staves[0].bars[i].voices[0].beats;
    ...
    it('pick-slide', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/pick-slide.gp');
        let score = reader.readScore();
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[0].slideOutType).toEqual(SlideOutType.PickSlideUp);
        ...
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[2].notes[0].slideOutType).toEqual(SlideOutType.PickSlideDown);
        ...
        expect(score.tracks[0].staves[0].bars[1].voices[0].beats[0].notes[0].slideOutType).toEqual(SlideOutType.PickSlideUp);
        ...
        expect(score.tracks[0].staves[0].bars[1].voices[0].beats[2].notes[0].slideOutType).toEqual(SlideOutType.PickSlideDown);
        ...
        expect(score.tracks[0].staves[0].bars[2].voices[0].beats[0].notes[0].slideOutType).toEqual(SlideOutType.PickSlideDown);
        expect(score.tracks[0].staves[0].bars[2].voices[0].beats[0].notes[0].fret).toEqual(20);
        expect(score.tracks[0].staves[0].bars[2].voices[0].beats[1].notes[0].slideOutType).toEqual(SlideOutType.PickSlideDown);
        expect(score.tracks[0].staves[0].bars[2].voices[0].beats[1].notes[0].fret).toEqual(12);
        expect(score.tracks[0].staves[0].bars[2].voices[0].beats[2].notes[0].slideOutType).toEqual(SlideOutType.PickSlideDown);
        expect(score.tracks[0].staves[0].bars[2].voices[0].beats[2].notes[0].fret).toEqual(5);
        expect(score.tracks[0].staves[0].bars[2].voices[0].beats[3].notes[0].slideOutType).toEqual(SlideOutType.PickSlideDown);
        ...
        expect(score.tracks[0].staves[0].bars[3].voices[0].beats[1].notes[0].slideOutType).toEqual(SlideOutType.PickSlideDown);
        expect(score.tracks[0].staves[0].bars[3].voices[0].beats[1].notes[0].fret).toEqual(12);
        expect(score.tracks[0].staves[0].bars[3].voices[0].beats[2].notes[0].slideOutType).toEqual(SlideOutType.PickSlideUp);
        expect(score.tracks[0].staves[0].bars[3].voices[0].beats[2].notes[0].fret).toEqual(5);
        expect(score.tracks[0].staves[0].bars[3].voices[0].beats[3].notes[0].slideOutType).toEqual(SlideOutType.PickSlideUp);
        expect(score.tracks[0].staves[0].bars[3].voices[0].beats[3].notes[0].fret).toEqual(10);
        expect(score.tracks[0].staves[0].bars[4].voices[0].beats[0].notes[0].slideOutType).toEqual(SlideOutType.PickSlideDown);
        expect(score.tracks[0].staves[0].bars[4].voices[0].beats[0].notes[0].fret).toEqual(20);
    }));
    it('beat-lyrics', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/beat-lyrics.gp');
        let score = reader.readScore();
    ...
    it('track-volume', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/track-volume.gp');
        let score = reader.readScore();
    ...
    it('track-balance', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/track-balance.gp');
        let score = reader.readScore();
    ...
    it('program-change', () => __awaiter(void 0, void 0, void 0, function* () {
        const reader = yield prepareGp7ImporterWithFile('guitarpro7/program-change.gp');
        let score = reader.readScore();
...
//# sourceMappingURL=Gp7Importer.test.js.map