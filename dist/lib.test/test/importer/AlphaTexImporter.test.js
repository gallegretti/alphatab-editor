...
describe('AlphaTexImporterTest', () => {
    ...
    it('hamonics-issue79', () => {
        let tex = ':8 3.3{nh} 3.3{ah} 3.3{th} 3.3{ph} 3.3{sh}';
        let score = parseTex(tex);
        expect(score.tracks.length).toEqual(1);
        expect(score.masterBars.length).toEqual(1);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats.length).toEqual(5);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[0].harmonicType).toEqual(HarmonicType.Natural);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[1].notes[0].harmonicType).toEqual(HarmonicType.Artificial);
    ...
    it('hamonics-rendering-text-issue79', () => {
        ...
        let renderer = new ScoreRenderer(settings);
        renderer.width = 970;
        let svg = '';
        ...
        let regexTemplate = '<text[^>]+>\\s*{0}\\s*</text>';
        expect(new RegExp(regexTemplate.replace('{0}', HarmonicsEffectInfo.harmonicToString(HarmonicType.Natural))).exec(svg)).toBeTruthy();
        expect(new RegExp(regexTemplate.replace('{0}', HarmonicsEffectInfo.harmonicToString(HarmonicType.Artificial))).exec(svg)).toBeTruthy();
        expect(new RegExp(regexTemplate.replace('{0}', HarmonicsEffectInfo.harmonicToString(HarmonicType.Tap))).exec(svg)).toBeTruthy();
        expect(new RegExp(regexTemplate.replace('{0}', HarmonicsEffectInfo.harmonicToString(HarmonicType.Pinch))).exec(svg)).toBeTruthy();
        expect(new RegExp(regexTemplate.replace('{0}', HarmonicsEffectInfo.harmonicToString(HarmonicType.Semi))).exec(svg)).toBeTruthy();
    });
    it('grace-issue79', () => {
        let tex = ':8 3.3{gr} 3.3{gr ob}';
        let score = parseTex(tex);
        expect(score.tracks.length).toEqual(1);
        expect(score.masterBars.length).toEqual(1);
    ...
    it('left-hand-finger-single-note', () => {
        let tex = ':8 3.3{lf 1} 3.3{lf 2} 3.3{lf 3} 3.3{lf 4} 3.3{lf 5}';
        let score = parseTex(tex);
        expect(score.tracks.length).toEqual(1);
        expect(score.masterBars.length).toEqual(1);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats.length).toEqual(5);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[0].leftHandFinger).toEqual(Fingers.Thumb);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[1].notes[0].leftHandFinger).toEqual(Fingers.IndexFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[2].notes[0].leftHandFinger).toEqual(Fingers.MiddleFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[3].notes[0].leftHandFinger).toEqual(Fingers.AnnularFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[4].notes[0].leftHandFinger).toEqual(Fingers.LittleFinger);
    });
    it('right-hand-finger-single-note', () => {
        let tex = ':8 3.3{rf 1} 3.3{rf 2} 3.3{rf 3} 3.3{rf 4} 3.3{rf 5}';
        let score = parseTex(tex);
        expect(score.tracks.length).toEqual(1);
        expect(score.masterBars.length).toEqual(1);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats.length).toEqual(5);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[0].rightHandFinger).toEqual(Fingers.Thumb);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[1].notes[0].rightHandFinger).toEqual(Fingers.IndexFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[2].notes[0].rightHandFinger).toEqual(Fingers.MiddleFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[3].notes[0].rightHandFinger).toEqual(Fingers.AnnularFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[4].notes[0].rightHandFinger).toEqual(Fingers.LittleFinger);
    });
    it('left-hand-finger-chord', () => {
        let tex = ':8 (3.1{lf 1} 3.2{lf 2} 3.3{lf 3} 3.4{lf 4} 3.5{lf 5})';
        let score = parseTex(tex);
        expect(score.tracks.length).toEqual(1);
        expect(score.masterBars.length).toEqual(1);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats.length).toEqual(1);
        ...
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[0].leftHandFinger).toEqual(Fingers.Thumb);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[1].leftHandFinger).toEqual(Fingers.IndexFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[2].leftHandFinger).toEqual(Fingers.MiddleFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[3].leftHandFinger).toEqual(Fingers.AnnularFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[4].leftHandFinger).toEqual(Fingers.LittleFinger);
    });
    it('right-hand-finger-chord', () => {
        let tex = ':8 (3.1{rf 1} 3.2{rf 2} 3.3{rf 3} 3.4{rf 4} 3.5{rf 5})';
        let score = parseTex(tex);
        expect(score.tracks.length).toEqual(1);
        expect(score.masterBars.length).toEqual(1);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats.length).toEqual(1);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes.length).toEqual(5);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[0].rightHandFinger).toEqual(Fingers.Thumb);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[1].rightHandFinger).toEqual(Fingers.IndexFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[2].rightHandFinger).toEqual(Fingers.MiddleFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[3].rightHandFinger).toEqual(Fingers.AnnularFinger);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[4].rightHandFinger).toEqual(Fingers.LittleFinger);
    });
    it('unstringed', () => {
        let tex = '\\tuning piano . c4 c#4 d4 d#4 | c4 db4 d4 eb4';
        let score = parseTex(tex);
        expect(score.tracks.length).toEqual(1);
        expect(score.masterBars.length).toEqual(2);
    ...
    it('multi-track', () => {
        let tex = '\\track "First" 1.1 | 1.1 | \\track "Second" 2.2 | 2.2';
        let score = parseTex(tex);
    ...
    it('multi-track-names', () => {
        let tex = '\\track 1.1 | 1.1 | \\track "Only Long Name" 2.2 | 2.2 | \\track "Very Long Name" "shrt" 3.3 | 3.3 ';
        let score = parseTex(tex);
    ...
    it('slides', () => {
        let tex = '3.3{sl} 4.3 | 3.3{ss} 4.3 | 3.3{sib} 3.3{sia} 3.3{sou} 3.3{sod} | 3.3{psd} 3.3{psu}';
        let score = parseTex(tex);
        expect(score.tracks.length).toEqual(1);
        ...
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].notes[0].slideTarget.id).toEqual(score.tracks[0].staves[0].bars[0].voices[0].beats[1].notes[0].id);
        ...
        expect(score.tracks[0].staves[0].bars[2].voices[0].beats[0].notes[0].slideInType).toEqual(SlideInType.IntoFromBelow);
        expect(score.tracks[0].staves[0].bars[2].voices[0].beats[1].notes[0].slideInType).toEqual(SlideInType.IntoFromAbove);
        expect(score.tracks[0].staves[0].bars[2].voices[0].beats[2].notes[0].slideOutType).toEqual(SlideOutType.OutUp);
        expect(score.tracks[0].staves[0].bars[2].voices[0].beats[3].notes[0].slideOutType).toEqual(SlideOutType.OutDown);
        expect(score.tracks[0].staves[0].bars[3].voices[0].beats[0].notes[0].slideOutType).toEqual(SlideOutType.PickSlideDown);
        expect(score.tracks[0].staves[0].bars[3].voices[0].beats[1].notes[0].slideOutType).toEqual(SlideOutType.PickSlideUp);
    });
    it('section', () => {
        let tex = '\\section Intro 1.1 | 1.1 | \\section "Chorus 01" 1.1 | \\section S Solo';
        let score = parseTex(tex);
        expect(score.tracks.length).toEqual(1);
        expect(score.masterBars.length).toEqual(4);
    ...
    it('triplet-feel-numeric', () => {
        let tex = '\\tf 0 | \\tf 1 | \\tf 2 | \\tf 3 | \\tf 4 | \\tf 5 | \\tf 6';
        let score = parseTex(tex);
    ...
    it('triplet-feel-long-names', () => {
        let tex = '\\tf none | \\tf triplet-16th | \\tf triplet-8th | \\tf dotted-16th | \\tf dotted-8th | \\tf scottish-16th | \\tf scottish-8th';
        let score = parseTex(tex);
        expect(score.masterBars[0].tripletFeel).toEqual(TripletFeel.NoTripletFeel);
        expect(score.masterBars[1].tripletFeel).toEqual(TripletFeel.Triplet16th);
        expect(score.masterBars[2].tripletFeel).toEqual(TripletFeel.Triplet8th);
    ...
    it('triplet-feel-short-names', () => {
        let tex = '\\tf no | \\tf t16 | \\tf t8 | \\tf d16 | \\tf d8 | \\tf s16 | \\tf s8';
        let score = parseTex(tex);
        expect(score.masterBars[0].tripletFeel).toEqual(TripletFeel.NoTripletFeel);
        expect(score.masterBars[1].tripletFeel).toEqual(TripletFeel.Triplet16th);
        expect(score.masterBars[2].tripletFeel).toEqual(TripletFeel.Triplet8th);
    ...
    it('tuplet-repeat', () => {
        let tex = ':8 5.3{tu 3}*3';
        let score = parseTex(tex);
        let durations = [Duration.Eighth, Duration.Eighth, Duration.Eighth];
        let tuplets = [3, 3, 3];
        let i = 0;
        let b = score.tracks[0].staves[0].bars[0].voices[0].beats[0];
        while (b) {
    ...
    it('simple-anacrusis', () => {
        let tex = '\\ac 3.3 3.3 | 1.1 2.1 3.1 4.1';
        let score = parseTex(tex);
    ...
    it('multi-bar-anacrusis', () => {
        let tex = '\\ac 3.3 3.3 | \\ac 3.3 3.3 | 1.1 2.1 3.1 4.1';
        let score = parseTex(tex);
        expect(score.masterBars[0].isAnacrusis).toBe(true);
    ...
    it('random-anacrusis', () => {
        let tex = '\\ac 3.3 3.3 | 1.1 2.1 3.1 4.1 | \\ac 3.3 3.3 | 1.1 2.1 3.1 4.1';
        let score = parseTex(tex);
        expect(score.masterBars[0].isAnacrusis).toBe(true);
    ...
    it('dynamics', () => {
        let tex = '1.1.8{dy ppp} 1.1{dy pp} 1.1{dy p} 1.1{dy mp} 1.1{dy mf} 1.1{dy f} 1.1{dy ff} 1.1{dy fff}';
        let score = parseTex(tex);
    ...
    it('dynamics-auto', () => {
        let tex = '1.1.4{dy ppp} 1.1 1.1{dy mp} 1.1';
        let score = parseTex(tex);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].dynamics).toEqual(DynamicValue.PPP);
    ...
    it('dynamics-auto-reset-on-track', () => {
        let tex = '1.1.4{dy ppp} 1.1 \\track "Second" 1.1.4';
        let score = parseTex(tex);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].dynamics).toEqual(DynamicValue.PPP);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[1].dynamics).toEqual(DynamicValue.PPP);
    ...
    it('dynamics-auto-reset-on-staff', () => {
        let tex = '1.1.4{dy ppp} 1.1 \\staff 1.1.4';
        let score = parseTex(tex);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[0].dynamics).toEqual(DynamicValue.PPP);
        expect(score.tracks[0].staves[0].bars[0].voices[0].beats[1].dynamics).toEqual(DynamicValue.PPP);
    ...
    it('crescendo', () => {
        let tex = '1.1.4{dec} 1.1{dec} 1.1{cre} 1.1{cre}';
        let score = parseTex(tex);
    ...
    it('left-hand-tapping', () => {
        let tex = ':4 1.1{lht} 1.1 1.1{lht} 1.1';
        let score = parseTex(tex);
...
//# sourceMappingURL=AlphaTexImporter.test.js.map