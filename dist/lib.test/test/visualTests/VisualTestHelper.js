...
export class VisualTestHelper {
     ...
     * @partial
     */
    static runVisualTest(inputFile, settings, tracks, message, tolerancePercent = 1, triggerResize = false) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const inputFileData = yield TestPlatform.loadFile(`test-data/visual-tests/${inputFile}`);
                ...
                yield VisualTestHelper.runVisualTestScore(score, referenceFileName, settings, tracks, message, tolerancePercent, triggerResize);
            }
            catch (e) {
     ...
     * @partial
     */
    static runVisualTestTex(tex, referenceFileName, settings, tracks, message, tolerancePercent = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!settings) {
                ...
                yield VisualTestHelper.runVisualTestScore(score, referenceFileName, settings, tracks, message);
            }
            catch (e) {
                fail(`Failed to run visual test ${e}`);
            }
     ...
     * @partial
     */
    static runVisualTestScore(score, referenceFileName, settings, tracks, message, tolerancePercent = 1, triggerResize = false) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                if (!settings) {
                    settings = new Settings();
                ...
                yield VisualTestHelper.loadFonts();
                let referenceFileData;
                try {
                    referenceFileData = yield TestPlatform.loadFile(`test-data/visual-tests/${referenceFileName}`);
                }
                catch (e) {
                ...
                yield VisualTestHelper.compareVisualResult(totalWidth, totalHeight, result, referenceFileName, referenceFileData, message, tolerancePercent);
            }
            catch (e) {
                fail(`Failed to run visual test ${e}`);
            }
     ...
     * @partial
     */
    static convertPngToCanvas(data, filename, className) {
     ...
     * @partial
     */
    static compareVisualResult(totalWidth, totalHeight, result, referenceFileName, referenceFileData, message, tolerancePercent = 1) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const partialResult of result) {
                ...
                if (partialCanvas instanceof HTMLCanvasElement) {
                    ...
                    imageSource = yield VisualTestHelper.convertSvgToImage(partialCanvas);
                }
                if (imageSource) {
            ...
            const expected = yield VisualTestHelper.convertPngToCanvas(referenceFileData, referenceFileName, 'expected-image');
            jasmine.addAsyncMatchers({
                toEqualVisually: VisualTestHelper.toEqualVisually
            });
            yield expectAsync(actual).toEqualVisually(expected, referenceFileName, message, tolerancePercent);
        });
    }
    /**
     * @target web
     * @partial
     */
    static toEqualVisually(_utils, _customEqualityTesters) {
        return {
            compare(actual, expected, expectedFileName, message, tolerancePercent = 1) {
                return __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        let match = PixelMatch.match(new Uint8Array(expectedImageData.data.buffer), new Uint8Array(actualImageData.data.buffer), new Uint8Array(diffImageData.data.buffer), expected.width, expected.height, {
                            threshold: 0.3,
                            includeAA: false,
                            diffMask: true,
                            alpha: 1
                        ...
                        if (!result.pass) {
                            ...
                            yield VisualTestHelper.saveFiles(expectedFileName, expected, oldActual, diff);
                        }
                    ...
                    `;
                        actual.ondblclick = () => {
                            ...
                            a.download = (_a = expected.dataset.filename) !== null && _a !== void 0 ? _a : 'reference.png';
                        ...
                        dom[Symbol.toPrimitive] = function () {
                            return errorMessage;
                        };
                        result.message = dom;
                    }
     ...
     * @partial
     */
    static saveFiles(name, expected, actual, diff) {
        return __awaiter(this, void 0, void 0, function* () {
            const expectedData = yield VisualTestHelper.toPngBlob(expected);
            const actualData = yield VisualTestHelper.toPngBlob(actual);
            const diffData = yield VisualTestHelper.toPngBlob(diff);
            return new Promise((resolve, reject) => {
    ...
    static createFileName(oldName, part) {
 ...
 * @partial
 */
VisualTestHelper._fontsLoaded = false;
//# sourceMappingURL=VisualTestHelper.js.map