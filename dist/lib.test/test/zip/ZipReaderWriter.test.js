...
describe('ZipReaderWriter', () => {
    it('simple-read', () => __awaiter(void 0, void 0, void 0, function* () {
        const data = yield TestPlatform.loadFile('test-data/guitarpro7/score-info.gp');
        ...
        expect(entries
            .map(e => e.data.length)
            .map(i => i.toString())
            .join(',')).toEqual('0,19651,14,27,192,22998,3');
    }));
    it('simple-roundtrip', () => {
...
//# sourceMappingURL=ZipReaderWriter.test.js.map